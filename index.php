        ...
        <section class="carre-contenu">
            ...
            <div class="column informations">
                ...
                <ul>
                    ...
                    <li>Télécharger mon CV <a href="ressources/CV_NICOLAS Marie_23.pdf">
                        <img src="img\icon_télécharger_transparent.gif" alt="Télécharger mon CV">
                    </a></li>
                    <li><a href="ressources/tableau de synthèse Épreuve E4.pdf">Télécharger le tableau de synthèse</a></li>
